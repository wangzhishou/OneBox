...
internal fun CipherControls(component: CipherComponent) {
    ...
    Column(horizontalAlignment = Alignment.CenterHorizontally) {
        ...
        Row(
            modifier = Modifier
                .flatGlassContainer(CircleShape)
        ...
        PreferenceItem(
            ...
            startIcon = com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineFile
        )
        Spacer(Modifier.height(16.dp))
        RoundedTextField(
            modifier = Modifier
        ...
        DataSelector(
            ...
            titleIcon = com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineKey,
            itemContentText = {
                it.name
            },
