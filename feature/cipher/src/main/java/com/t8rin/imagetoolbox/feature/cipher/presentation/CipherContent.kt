...
import com.t8rin.imagetoolbox.core.resources.icons.line.LineShieldOpen
    ...
    AdaptiveLayoutScreen(
        ...
        buttons = {
            BottomButtonsBlock(
                ...
                secondaryButtonIcon = com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineFileOpen,
                ...
                primaryButtonIcon = if (component.isEncrypt) {
                    com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineShieldKey
                } else {
                    com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineShieldOpen
                },
                ...
                actions = {
                    if (isPortrait) {
                        Spacer(Modifier.width(AppTheme.dimens.spaceSmall))
                        TopAppBarEmoji()
                    }
                }
            )
