...
import com.wanbaohe.gomoku.application.dto.NotationRow
...
@Composable
fun GomokuAnalysisScreen(
    component: GomokuAnalysisComponent,
    ...
    if (showChrome) {
        BaseScreen(
            title = state.title.ifBlank { stringResource(R.string.gomoku_analysis_title) },
...
@Composable
private fun GomokuAnalysisContent(
    component: GomokuAnalysisComponent,
    modifier: Modifier,
    onExport: () -> Unit,
    resultText: String,
    ...
    Column(
        ...
        GlassSurface(
            ...
            Column(modifier = Modifier.fillMaxWidth()) {
                ...
                if (rows.isEmpty()) {
                    Text(
                        text = stringResource(R.string.gomoku_no_history),
...
private fun AnalysisPanelHeader(
    ...
    Row(
        ...
        Text(
            text = stringResource(R.string.gomoku_analysis_panel_title),
        ...
        Row(
            ...
            Text(
                text = stringResource(R.string.gomoku_ply_count, moveCount),
            ...
            GlassTonalIconButton(onClick = onToggleSound) {
                Icon(
                    ...
                    contentDescription = stringResource(
                        if (isSoundOn) R.string.gomoku_analysis_sound_on else R.string.gomoku_analysis_sound_off,
                    ),
                    modifier = Modifier.size(18.dp),
                )
            }
            GlassTonalIconButton(onClick = onExport) {
                Icon(
                    ...
                    contentDescription = stringResource(R.string.gomoku_export),
                    modifier = Modifier.size(18.dp),
                )
            }
        }
    ...
    Row(
        ...
        GlassTonalIconButton(onClick = onStart) {
            Icon(
                ...
                contentDescription = stringResource(R.string.gomoku_replay_to_start),
        ...
        GlassTonalIconButton(onClick = onPrev) {
            Icon(
                ...
                contentDescription = stringResource(R.string.gomoku_replay_prev),
            )
        }
        GlassTonalIconButton(
            ...
            Icon(
                ...
                contentDescription = stringResource(
                    if (isAutoPlaying) R.string.gomoku_replay_pause else R.string.gomoku_replay_auto_play,
                ),
        ...
        GlassTonalIconButton(onClick = onNext) {
            Icon(
                ...
                contentDescription = stringResource(R.string.gomoku_replay_next),
            )
        }
        GlassTonalIconButton(onClick = onEnd) {
            Icon(
                imageVector = com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineSkipNext,
                contentDescription = stringResource(R.string.gomoku_replay_to_end),
                modifier = Modifier.scale(SKIP_ICON_SCALE),
            )
        }
    }
