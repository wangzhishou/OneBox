...
fun localizedGameResultText(resultCode: String): String = when (resultCode) {
    GameResultCode.BLACK -> stringResource(R.string.gomoku_game_over_black)
    GameResultCode.WHITE -> stringResource(R.string.gomoku_game_over_white)
    GameResultCode.DRAW -> stringResource(R.string.gomoku_game_over_draw)
    GameResultCode.RESIGNED -> stringResource(R.string.gomoku_resign_result)
    else -> ""
}
