...
@Composable
fun AppExitDialog(component: RootComponent) {
    val currentScreen = component.childStack.subscribeAsState().value.active.configuration

    if (currentScreen is Screen.App) {
