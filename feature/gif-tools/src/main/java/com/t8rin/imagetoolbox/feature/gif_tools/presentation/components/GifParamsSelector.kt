...
fun GifParamsSelector(
    ...
    Column {
        ...
        PreferenceRowSwitch(
            ...
            startIcon = com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LinePhotoSizeLarge,
        ...
        PreferenceRowSwitch(
            ...
            startIcon = com.t8rin.imagetoolbox.core.resources.Icons.Outlined.Stack,
            modifier = Modifier.fillMaxWidth(),
            containerColor = Color.Unspecified,
            shape = ShapeDefaults.extraLarge
        )
        ...
        EnhancedSliderItem(
            value = value.fps,
            icon = com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineFilterFrames,
        ...
        PreferenceRowSwitch(
            ...
            startIcon = com.t8rin.imagetoolbox.core.resources.Icons.Filled.Transparency,
            modifier = Modifier.fillMaxWidth(),
            containerColor = Color.Unspecified,
            shape = ShapeDefaults.extraLarge
        )
        AnimatedVisibility(value.crossfadeCount > 1) {
            EnhancedSliderItem(
                ...
                icon = com.t8rin.imagetoolbox.core.resources.Icons.Outlined.Counter,
