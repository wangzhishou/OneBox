...
import com.t8rin.imagetoolbox.core.resources.icons.line.LineTimelapse
...
fun ApngParamsSelector(
    ...
    Column {
        ...
        EnhancedSliderItem(
            ...
            icon = com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineStream,
            valueRange = 0f..9f,
            steps = 9,
            ...
            Text(
                ...
                modifier = Modifier
                    .padding(4.dp)
                    .flatGlassContainer(ShapeDefaults.large)
                    .padding(4.dp)
            )
        }
        Spacer(modifier = Modifier.height(8.dp))
        ...
        EnhancedSliderItem(
            value = value.delay,
            icon = com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineTimelapse,
