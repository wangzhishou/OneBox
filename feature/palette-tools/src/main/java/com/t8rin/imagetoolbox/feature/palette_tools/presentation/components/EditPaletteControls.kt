...
internal fun EditPaletteControls(
    ...
    DataSelector(
        ...
        titleIcon = com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineFile,
        itemContentText = {
    ...
    Column(
        modifier = Modifier.flatGlassContainer(resultPadding = 8.dp),
        ...
        (palette.colors + null).forEachIndexed { index, data ->
            ...
            if (data == null) {
                PreferenceItem(
                    ...
                    startIcon = com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineTheme,
                    endIcon = com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineAddCircleOutline,
                    modifier = Modifier
                        .fillMaxWidth()
                        .padding(top = 4.dp),
