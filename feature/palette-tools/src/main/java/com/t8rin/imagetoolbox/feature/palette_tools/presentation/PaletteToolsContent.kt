            ...
            items = listOf(
                @Composable {
                    TypeSelectionCard(
                        ...
                        icon = com.t8rin.imagetoolbox.core.resources.Icons.Outlined.PaletteSwatch,
                        index = 0,
    ...
    AdaptiveLayoutScreen(
        ...
        actions = {
            ...
            if (component.bitmap != null) {
                EnhancedIconButton(
                    ...
                    Icon(
                        imageVector = com.t8rin.imagetoolbox.core.resources.Icons.Outlined.Eyedropper,
        ...
        buttons = { actions ->
            ...
            OneBoxImageScreenBottomBar(
                ...
                isSaveVisible = paletteType == PaletteType.Edit && component.palette.isNotEmpty(),
                pickImageText = stringResource(
