...
import com.t8rin.imagetoolbox.core.resources.icons.line.LinePercent
...
internal fun SplitParamsSelector(
    ...
    EnhancedSliderItem(
        ...
        icon = com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineTableRows,
        valueRange = 1f..20f,
        steps = 18,
    ...
    EnhancedSliderItem(
        ...
        steps = 18,
        icon = com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineViewColumn,
        valueRange = 1f..20f,
        internalStateTransformation = {
            it.roundToInt()
        },
...
private fun PercentagesField(
    ...
    Row(
        ...
        TitleItem(
            ...
            icon = com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LinePercent,
