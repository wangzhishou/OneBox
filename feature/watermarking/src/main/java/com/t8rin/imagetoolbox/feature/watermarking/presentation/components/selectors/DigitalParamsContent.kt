...
import com.t8rin.imagetoolbox.core.resources.icons.line.LineDisabledVisible
import com.t8rin.imagetoolbox.core.resources.icons.line.LineGraphicEq
    ...
    AnimatedVisibility(
        ...
        Column {
            PreferenceRowSwitch(
                ...
                checked = isInvisible,
                startIcon = com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineDisabledVisible,
                onClick = {
                    onValueChange(
                        params.copy(
...
//                    startIcon = com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineGraphicEq,
//                    onClick = {
//                        onValueChange(
//                            params.copy(
//                                digitalParams = digitalParams?.copy(
