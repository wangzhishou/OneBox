...
internal val GLASSMORPHISM_ENABLED = booleanPreferencesKey("GLASSMORPHISM_ENABLED")
internal val LIQUID_GLASS_ENABLED = booleanPreferencesKey("LIQUID_GLASS_ENABLED")
internal val MESH_GRADIENT_BACKGROUND_ENABLED = booleanPreferencesKey("MESH_GRADIENT_BACKGROUND_ENABLED")
internal val CUSTOM_BACKGROUND_IMAGE_URI = stringPreferencesKey("CUSTOM_BACKGROUND_IMAGE_URI")
internal val GRADIENT_BACKGROUND_STYLE = intPreferencesKey("GRADIENT_BACKGROUND_STYLE")
internal val CUSTOM_BACKGROUND_OVERLAY_ALPHA = floatPreferencesKey("CUSTOM_BACKGROUND_OVERLAY_ALPHA")
