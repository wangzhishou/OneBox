...
internal fun Preferences.toSettingsState(
    ...
    isGlassmorphismEnabled = this[GLASSMORPHISM_ENABLED]
        ?: default.isGlassmorphismEnabled,
    isLiquidGlassEnabled = this[LIQUID_GLASS_ENABLED]
        ?: default.isLiquidGlassEnabled,
    isMeshGradientBackgroundEnabled = this[MESH_GRADIENT_BACKGROUND_ENABLED]
        ?: default.isMeshGradientBackgroundEnabled,
    customBackgroundImageUri = this[CUSTOM_BACKGROUND_IMAGE_URI]
        ?: default.customBackgroundImageUri,
    gradientBackgroundStyle = this[GRADIENT_BACKGROUND_STYLE]
        ?.let { GradientBackgroundStyle.fromOrdinal(it) }
        ?: default.gradientBackgroundStyle,
    customBackgroundOverlayAlpha = this[CUSTOM_BACKGROUND_OVERLAY_ALPHA]
