...
class SettingsComponent @AssistedInject internal constructor(
    ...
    fun toggleGlassmorphismEnabled() =
        settingsScope { toggleGlassmorphismEnabled() }

    fun toggleLiquidGlassEnabled() =
        settingsScope { toggleLiquidGlassEnabled() }

    fun toggleMeshGradientBackgroundEnabled() =
        settingsScope { toggleMeshGradientBackgroundEnabled() }

    fun setCustomBackgroundImageUri(uri: String?) =
        settingsScope { setCustomBackgroundImageUri(uri) }

    fun setGradientBackgroundStyle(style: GradientBackgroundStyle) =
        settingsScope { setGradientBackgroundStyle(style) }

    fun setCustomBackgroundOverlayAlpha(alpha: Float) =
        settingsScope { setCustomBackgroundOverlayAlpha(alpha) }
