...
import com.t8rin.imagetoolbox.feature.settings.data.AndroidThemeRepository
import com.t8rin.imagetoolbox.feature.settings.data.ThemeSettingServiceImpl
import dagger.Binds
...
internal interface SettingsModule {
    ...
    fun provideThemeRepository(
        impl: AndroidThemeRepository
    ): ThemeRepository

    @Singleton
    @Binds
    fun provideThemeSettingService(
        impl: ThemeSettingServiceImpl
    ): ThemeSettingService
