...
internal fun AddEditMaskSheetControls(
    ...
    Row(
        Modifier
            ...
            .flatGlassContainer(shape = CircleShape)
    ) {
        PanModeButton(
            selected = panEnabled,
    ...
    AnimatedVisibility(visible = canSave) {
        Column {
            ...
            PreferenceRowSwitch(
                ...
                startIcon = com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineVisibility
            )
        }
    }
        ...
        if (notEmpty) {
            ...
            Column(
                modifier = Modifier
                    ...
                    .flatGlassContainer(MaterialTheme.shapes.extraLarge)
            ) {
