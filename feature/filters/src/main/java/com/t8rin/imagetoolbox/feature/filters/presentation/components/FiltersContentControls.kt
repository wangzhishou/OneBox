        ...
        is Screen.Filter.Type.Basic -> {
            ...
            if (component.bitmap != null) {
                ...
                AnimatedContent(
                    ...
                    if (notEmpty) {
                        Column(Modifier.flatGlassContainer(MaterialTheme.shapes.extraLarge)) {
                            ...
                            Column(
                                ...
                                filterList.forEachIndexed { index, filter ->
                                    val filterName = stringResource(filter.title)
                                    FilterItem(
                                ...
                                val templateName = stringResource(
                                    filterList.firstOrNull()?.title ?: R.string.template_filter
                                )
                                AddFilterButton(
                        ...
                        Column(Modifier.flatGlassContainer(MaterialTheme.shapes.extraLarge)) {
                            ...
                            Column(
                                ...
                                maskList.forEachIndexed { index, mask ->
                                    val maskTemplateName = stringResource(
                                        mask.filters.firstOrNull()?.toUiFilter()?.title
