...
import com.t8rin.imagetoolbox.core.resources.icons.line.LineContact
...
private fun ColumnScope.ContactInfoEnterBlock(
    ...
    RoundedTextField(
        ...
        startIcon = { Icon(com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineBusiness, null) }
    )
    ...
    RoundedTextField(
        ...
        startIcon = { Icon(com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineBadge, null) }
    )
}
...
private fun ColumnScope.NameEditField(
    ...
    RoundedTextField(
        ...
        startIcon = { Icon(com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineContact, null) }
    )
    ...
    RoundedTextField(
        ...
        startIcon = { Icon(com.t8rin.imagetoolbox.core.resources.Icons.Filled.Prefix, null) }
    )
    ...
    RoundedTextField(
        ...
        startIcon = { Icon(com.t8rin.imagetoolbox.core.resources.Icons.Filled.Suffix, null) }
    )
    ...
    RoundedTextField(
        ...
        startIcon = { Icon(com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineRecordVoiceOver, null) }
    )
}
...
private fun ColumnScope.UrlsEnterBlock(
    ...
    value.urls.forEachIndexed { index, url ->
        RemovableTextField(
            ...
            startIcon = com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineLink,
...
private fun ColumnScope.AddressesEnterBlock(
    ...
    value.addresses.forEachIndexed { index, address ->
        RemovableTextField(
            ...
            startIcon = com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LinePlace,
...
private fun ColumnScope.EmailsEnterBlock(
    ...
    TitleItem(
        ...
        icon = com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineEmail,
        modifier = Modifier.padding(vertical = 8.dp)
    )
    ...
    value.emails.forEachIndexed { index, email ->
        RemovableTextField(
            ...
            startIcon = com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineAtEmail,
...
private fun ColumnScope.PhonesEnterBlock(
    ...
    value.phones.forEachIndexed { index, phone ->
        RemovableTextField(
            ...
            startIcon = com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineNumbers,
...
private fun RemovableTextField(
    ...
    Row(
        ...
        EnhancedIconButton(
            ...
            Icon(
                imageVector = com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineRemove,
                contentDescription = null,
...
private fun AddButton(
    ...
    EnhancedButton(
        ...
        Icon(com.t8rin.imagetoolbox.core.resources.Icons.Outlined.Add, null)
