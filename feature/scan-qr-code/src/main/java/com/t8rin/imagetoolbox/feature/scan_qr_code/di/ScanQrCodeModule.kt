...
import com.t8rin.imagetoolbox.feature.scan_qr_code.data.DefaultScanCodeResultResolver
import com.t8rin.imagetoolbox.feature.scan_qr_code.data.MmkvScanHistoryRepository
...
internal interface ScanQrCodeModule {
    ...
    @Binds
    @Singleton
    fun scanHistoryRepository(
        impl: MmkvScanHistoryRepository
    ): ScanHistoryRepository

    @Binds
    @Singleton
    fun scanCodeResultResolver(
        impl: DefaultScanCodeResultResolver
