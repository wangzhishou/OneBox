...
internal fun QrSmsEditField(
    ...
    Column(
        ...
        RoundedTextField(
            ...
            startIcon = {
                Icon(
                    imageVector = com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineNumbers,
        ...
        RoundedTextField(
            ...
            startIcon = {
                Icon(
                    imageVector = com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineStickyNote,
                    contentDescription = null
                )
            },
            singleLine = false
