...
internal fun QrWifiEditField(
    ...
    Column(
        ...
        DataSelector(
            ...
            titleIcon = com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineSecurity,
            itemContentText = { it.name },
            itemContentIcon = { _, selected -> if (selected) com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineCheckCircleOutline else null },
            spanCount = 1,
