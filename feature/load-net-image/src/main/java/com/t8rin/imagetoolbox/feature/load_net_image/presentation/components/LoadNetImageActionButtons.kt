...
internal fun LoadNetImageActionButtons(
    ...
    BottomButtonsBlock(
        ...
        secondaryButtonIcon = if (noData) com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineContentPaste else Icons.Outlined.ImageEdit,
