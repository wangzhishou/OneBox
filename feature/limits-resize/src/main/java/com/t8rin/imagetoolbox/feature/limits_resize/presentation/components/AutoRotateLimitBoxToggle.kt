...
import com.t8rin.imagetoolbox.core.resources.icons.line.LineMotionPhotos
...
fun AutoRotateLimitBoxToggle(
    ...
    PreferenceRowSwitch(
        ...
        startIcon = com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineMotionPhotos
    )
}