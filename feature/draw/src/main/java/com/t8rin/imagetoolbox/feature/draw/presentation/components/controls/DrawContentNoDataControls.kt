...
internal fun DrawContentNoDataControls(
    ...
    LazyVerticalStaggeredGrid(
        ...
        item {
            PreferenceItem(
                onClick = onPickImage,
                startIcon = com.t8rin.imagetoolbox.core.resources.Icons.Outlined.ImageTooltip,
        ...
        item {
            PreferenceItem(
                ...
                startIcon = com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineFormatPaint,
    ...
    EnhancedModalBottomSheet(
        title = {
            TitleItem(
                ...
                icon = com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineFormatPaint
            )
        },
        confirmButton = {
            EnhancedButton(
