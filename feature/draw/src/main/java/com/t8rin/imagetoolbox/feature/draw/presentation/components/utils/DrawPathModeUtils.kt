...
internal fun DrawPathMode.getIcon(): ImageVector = when (this) {
    is DrawPathMode.DoubleLinePointingArrow -> com.t8rin.imagetoolbox.core.resources.Icons.Rounded.LineDoubleArrow
    is DrawPathMode.DoublePointingArrow -> com.t8rin.imagetoolbox.core.resources.Icons.Rounded.FreeDoubleArrow
    DrawPathMode.Free -> com.t8rin.imagetoolbox.core.resources.Icons.Rounded.FreeDraw
    DrawPathMode.Line -> com.t8rin.imagetoolbox.core.resources.Icons.Rounded.Line
    is DrawPathMode.LinePointingArrow -> com.t8rin.imagetoolbox.core.resources.Icons.Rounded.LineArrow
    is DrawPathMode.PointingArrow -> com.t8rin.imagetoolbox.core.resources.Icons.Rounded.FreeArrow
    DrawPathMode.OutlinedOval -> com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineRadioUnchecked
    is DrawPathMode.OutlinedRect -> com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineCheckBoxBlank
    DrawPathMode.Oval -> com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineCircle
    is DrawPathMode.Rect -> com.t8rin.imagetoolbox.core.resources.Icons.Rounded.Square
    DrawPathMode.Lasso -> com.t8rin.imagetoolbox.core.resources.Icons.Rounded.Lasso
    DrawPathMode.Triangle -> com.t8rin.imagetoolbox.core.resources.Icons.Rounded.Triangle
    DrawPathMode.OutlinedTriangle -> com.t8rin.imagetoolbox.core.resources.Icons.Outlined.Triangle
    is DrawPathMode.Polygon -> com.t8rin.imagetoolbox.core.resources.Icons.Rounded.Polygon
    is DrawPathMode.OutlinedPolygon -> com.t8rin.imagetoolbox.core.resources.Icons.Outlined.Polygon
    is DrawPathMode.OutlinedStar -> com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineStar
    is DrawPathMode.Star -> com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineStar
    is DrawPathMode.FloodFill -> com.t8rin.imagetoolbox.core.resources.Icons.Rounded.FloodFill
    is DrawPathMode.Spray -> com.t8rin.imagetoolbox.core.resources.Icons.Outlined.Spray
}