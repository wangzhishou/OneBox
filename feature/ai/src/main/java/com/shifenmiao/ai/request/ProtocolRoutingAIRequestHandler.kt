...
class ProtocolRoutingAIRequestHandler @Inject constructor(
    ...
    private fun createChatCall(
        ...
        return when (engine.requestProtocol) {
            ...
            // Pikafish 不是 chat 协议, 走 PikafishMoveChooser / XiangqiEngineService 链路。
            AiRequestProtocol.PIKAFISH -> error("PIKAFISH engine should be routed via PikafishMoveChooser, not ProtocolRoutingAIRequestHandler")
