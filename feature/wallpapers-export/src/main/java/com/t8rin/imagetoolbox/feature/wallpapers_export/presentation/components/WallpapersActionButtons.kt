...
internal fun WallpapersActionButtons(
    ...
    BottomButtonsBlock(
        ...
        secondaryButtonIcon = if (noData) com.t8rin.imagetoolbox.core.resources.Icons.Outlined.Refresh else com.t8rin.imagetoolbox.core.resources.Icons.Outlined.ImageEdit,
