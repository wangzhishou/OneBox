...
import com.t8rin.imagetoolbox.core.resources.icons.line.LineDensitySmall
    ...
    Column(
        ...
        if (screenType.isMesh()) {
            ...
            EnhancedSliderItem(
                ...
                icon = com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineGridOn,
                valueRange = 2f..6f,
            ...
            EnhancedSliderItem(
                ...
                icon = com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineDensitySmall,
                valueRange = 1f..64f,
                internalStateTransformation = { it.roundToInt() },
