 ...
 * to RichText.
 */
val LocalInternalTextStyle = compositionLocalOf { TextStyle.Default }
 ...
 */
val LocalInternalContentColor = compositionLocalOf { Color.Black }

/**
 * The current [TextStyle].
 */
val RichTextScope.currentTextStyle: TextStyle
  @Composable get() = textStyleProvider()

/**
 * The current content [Color].
 */
val RichTextScope.currentContentColor: Color
