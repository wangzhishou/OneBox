package io.noties.markwon.prism4j.syntax;
...
public abstract class Prism4jThemeBase implements Prism4jTheme {
    ...
    public final ColorHashMap colorHashMap;

    protected Prism4jThemeBase() {
        this.colorHashMap = initColorHashMap();
    }

    @NonNull
    public abstract ColorHashMap initColorHashMap();
