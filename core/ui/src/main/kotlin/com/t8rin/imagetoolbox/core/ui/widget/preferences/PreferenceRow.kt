...
fun PreferenceRow(
    ...
    pressedShape: Shape = OneBoxDesignSystem.compactBadgeShape,
    ...
    CompositionLocalProvider(
        ...
        val rowModifier = modifier
            .then(
                if (applyHorizontalPadding) {
                    Modifier.padding(horizontal = OneBoxDesignSystem.screenPadding)
                } else Modifier
            )
            .then(
                if (drawContainer) {
        ...
        val rowContent: @Composable (Modifier) -> Unit = { modifier ->
            Row(
                    ...
                    ProvideContainerDefaults(
                        ...
                        if (drawStartIconContainer) {
                            IconShapeContainer(
                                ...
                                modifier = Modifier.padding(end = OneBoxDesignSystem.screenPadding)
                            )
                        } else content()
                    }
                }
                ...
                Spacer(Modifier.width(OneBoxDesignSystem.compactSpacing))
...
fun PreferenceRow(
    ...
    PreferenceRow(
        ...
        resultModifier = if (endContent != null) {
            Modifier.padding(
                top = OneBoxDesignSystem.compactSpacing,
                start = OneBoxDesignSystem.screenPadding,
                bottom = OneBoxDesignSystem.compactSpacing
            )
        } else Modifier.padding(OneBoxDesignSystem.screenPadding),
