...
private class BarcodeScannerImpl(
    ...
    override fun scan(contextActivity: ComponentActivity) {
...
interface BarcodeScanner {
    fun scan(contextActivity: ComponentActivity)
}
...
fun rememberBarcodeScanner(
    ...
    val scannerLauncher = rememberLauncherForActivityResult(ScanCustomCode()) { result ->
        ...
        when (result) {
            is QRResult.QRError -> AppToastHost.showFailureToast(result.exception)
