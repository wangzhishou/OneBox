...
fun PreferenceItemOverload(
    ...
    modifier: Modifier = Modifier
        .fillMaxWidth()
        .padding(horizontal = OneBoxDesignSystem.compactSpacing),
                ...
                startIcon?.let {
                    ProvideContainerDefaults(
                        ...
                        Row {
                            ...
                            Spacer(modifier = Modifier.width(OneBoxDesignSystem.screenPadding))
                        }
                    }
                }
                Column(
                    Modifier
                        .weight(1f)
                        .padding(end = OneBoxDesignSystem.screenPadding)
                ) {
                    Row {
                        AnimatedContent(
                            targetState = title,
