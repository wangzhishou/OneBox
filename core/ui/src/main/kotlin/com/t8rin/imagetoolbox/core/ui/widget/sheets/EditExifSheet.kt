    ...
    EnhancedModalBottomSheet(
        confirmButton = {
            ...
            Row(
                ...
                Spacer(Modifier.width(OneBoxDesignSystem.microSpacing))
                OneSecondaryButton(
        ...
        title = {
            TitleItem(
                ...
                icon = com.t8rin.imagetoolbox.core.resources.Icons.Rounded.Exif,
        ...
        if (exifMap?.isEmpty() == false) {
            ...
            Column(
                ...
                Icon(
                    imageVector = com.t8rin.imagetoolbox.core.resources.Icons.Outlined.Exif,
                    contentDescription = null,
                    modifier = Modifier
                        .weight(2f)
