            ...
            EnhancedAlertDialogContent(
                ...
                modifier = modifier
                    .then(
                        ...
                        else Modifier.alertDialogBorder()
                    )
                    .sizeIn(
        ...
        FullscreenPopup(placeAboveAll = placeAboveAll) {
            Box(
                ...
                AnimatedVisibility(
                    ...
                    val alpha = if (useGlass) 0.50f * animatedScale else 0.5f * animatedScale
                    ...
                    Box(
                        modifier = Modifier
                            ...
                            .background(baseScrim.copy(alpha = alpha))
                            .fillMaxSize()
                    )
                }
                AnimatedVisibility(
            ...
            if (onDismissRequest != null && properties.dismissOnBackPress) {
