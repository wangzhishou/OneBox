...
fun FontSelectionItem(
    ...
    ProvideTypography(font) {
        PreferenceItem(
            ...
            shape = shape,
            endIcon = if (selected) com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineRadioChecked else com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineRadioUnchecked
        )
    }
}
