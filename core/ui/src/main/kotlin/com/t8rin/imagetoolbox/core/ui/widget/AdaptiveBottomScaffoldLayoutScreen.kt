...
fun AdaptiveBottomScaffoldLayoutScreen(
    ...
    val content: @Composable (PaddingValues) -> Unit = { paddingValues ->
        Box(
            ...
            Column(horizontalAlignment = Alignment.CenterHorizontally) {
                ...
                } else EnhancedTopAppBarDefaults.colors()
    ...
    Surface(
        color = if (settingsState.isGlassAlphaEnabled) Color.Transparent else MaterialTheme.colorScheme.background,
        ...
        AnimatedContent(
            ...
            if (useScaffold) {
                ...
                BottomSheetScaffold(
                    modifier = Modifier.fillMaxSize(),
                    containerColor = Color.Transparent,
                    sheetContainerColor = EnhancedBottomSheetDefaults.contentContainerColor,
