            ...
            override val visuals: ToastVisuals
                get() = object : ToastVisuals {
                    override val message: String
                        get() = "File successfully saved to Documents/OneBox"
                    override val icon: ImageVector
                        get() = com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineFolder
...
suspend fun ToastHostState.showFailureToast(
    ...
    icon = if (throwable is OutOfMemoryError) {
        com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineMemory
    } else {
        null
    }
)
...
suspend fun ToastHostState.showFailureToast(
    ...
    message = message,
    icon = icon ?: com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineError,
