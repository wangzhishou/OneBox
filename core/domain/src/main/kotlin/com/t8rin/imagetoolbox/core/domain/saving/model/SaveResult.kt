...
sealed class SaveResult(
    open val savingPath: String? = null
) {

    data class Success(
        val message: String? = null,
        override val savingPath: String? = null,
        val fileUri: String? = null,
        val fileName: String? = null,
        val isOverwritten: Boolean = false,
        /** The tree URI of the parent directory, used for FileBrowser navigation. */
...
fun List<SaveResult>.onSuccess(
    ...
    this.filterIsInstance<Success>().forEach { action(it) }
}