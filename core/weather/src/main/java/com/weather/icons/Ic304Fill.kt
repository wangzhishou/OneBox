...
val QWeatherIcons.Ic304Fill: ImageVector
    get() {
        val current = _ic304Fill
        if (current != null) return current

        return ImageVector.Builder(
            name = "QWeather.Ic304Fill",
            defaultWidth = 16.0.dp,
            defaultHeight = 16.0.dp,
            viewportWidth = 16.0f,
            viewportHeight = 16.0f,
        ).apply {
            // M11.727 8.217 A4.99 4.99 0 0 1 7.9 10 a4.988 4.988 0 0 1 -3.773 -1.719 3 3 0 1 1 -.586 -5.732 A4.998 4.998 0 0 1 7.9 0 a4.999 4.999 0 0 1 4.38 2.587 3 3 0 1 1 -.553 5.63Z M3 13 a1 1 0 1 0 2 0 c0 -.5 -.555 -1.395 -1 -2 -.445 .605 -1 1.5 -1 2Z m10 -.5 a1 1 0 1 1 -2 0 1 1 0 0 1 2 0Z m-4.54 .126 c-.054 0 -.089 -.05 -.065 -.093 l.792 -1.438 C9.21 11.05 9.176 11 9.122 11 H7.544 a.147 .147 0 0 0 -.076 .02 .158 .158 0 0 0 -.058 .057 l-1.397 2.637 c-.042 .079 .022 .17 .118 .17 h1.42 c.05 0 .084 .043 .069 .086 l-.739 1.943 c-.027 .07 .072 .118 .124 .063 l2.978 -3.243 c.04 -.042 .006 -.107 -.055 -.107 H8.46Z
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 11.727 8.217
                moveTo(x = 11.727f, y = 8.217f)
                ...
                close()
                // m 10 -0.5
                moveToRelative(dx = 10.0f, dy = -0.5f)
                // a 1 1 0 1 1 -2 0
                arcToRelative(
                    a = 1.0f,
                    b = 1.0f,
                ...
                close()
                // m -4.54 0.126
                moveToRelative(dx = -4.54f, dy = 0.126f)
        ...
        }.build().also { _ic304Fill = it }
    }

@Suppress("ObjectPropertyName")
private var _ic304Fill: ImageVector? = null
