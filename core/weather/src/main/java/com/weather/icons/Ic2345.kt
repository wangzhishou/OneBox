...
val QWeatherIcons.Ic2345: ImageVector
    get() {
        val current = _ic2345
        if (current != null) return current

        return ImageVector.Builder(
            name = "QWeather.Ic2345",
            ...
            // M5.698 2.464 c.346 -.015 .8 -.032 1.302 -.042 V5.01 c-.46 .1 -.882 .198 -1.227 .281 l.048 -.171 C5.914 4.775 6 4.364 6 4 c0 -.383 -.096 -.82 -.195 -1.18 a9.243 9.243 0 0 0 -.107 -.356Z M8 2.414 c.509 .002 1.026 .015 1.5 .047 v2.094 c-.477 .063 -.992 .151 -1.5 .25 V2.413Z m2.5 .15 c.478 .067 .995 .159 1.5 .26 v1.59 a26.44 26.44 0 0 0 -1.5 .045 V2.564Z m2.5 .47 c.62 .137 1.16 .27 1.5 .354 v1.084 c-.368 -.017 -.9 -.039 -1.5 -.05 V3.034Z M5.11 1.493 a.601 .601 0 0 0 -.527 .814 c.06 .159 .167 .454 .258 .781 .093 .337 .159 .668 .159 .912 0 .23 -.058 .54 -.145 .86 a9.06 9.06 0 0 1 -.251 .778 c-.166 .444 .23 .92 .713 .796 .706 -.18 3.118 -.775 4.733 -.936 1.693 -.17 4.26 -.037 4.817 -.005 a.6 .6 0 0 0 .633 -.6 V3.077 a.6 .6 0 0 0 -.449 -.58 c-.47 -.122 -3.184 -.813 -5.001 -.995 -1.75 -.175 -4.328 -.044 -4.94 -.01Z m7.418 5.726 a.296 .296 0 0 0 -.494 -.133 l-5.949 5.955 a.292 .292 0 0 0 .134 .488 l8.123 2.176 a.292 .292 0 0 0 .36 -.355 l-2.174 -8.131Z M10.98 9.3 c.047 -.315 .43 -.495 .83 -.388 .398 .107 .64 .454 .523 .751 l-1.027 2.608 -.74 -.198 .414 -2.773Z m.212 4.105 a.563 .563 0 1 1 -1.086 -.291 .563 .563 0 0 1 1.086 .291Z
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 5.698 2.464
                ...
                close()
                // m 7.418 5.726
                moveToRelative(dx = 7.418f, dy = 5.726f)
                // a 0.296 0.296 0 0 0 -0.494 -0.133
                arcToRelative(
                    a = 0.296f,
                    b = 0.296f,
                    theta = 0.0f,
                ...
                // a 0.292 0.292 0 0 0 0.134 0.488
                arcToRelative(
                    a = 0.292f,
                    b = 0.292f,
                    theta = 0.0f,
                ...
                // l 8.123 2.176
                lineToRelative(dx = 8.123f, dy = 2.176f)
                // a 0.292 0.292 0 0 0 0.36 -0.355
                arcToRelative(
                    a = 0.292f,
                    b = 0.292f,
                    theta = 0.0f,
                ...
                // l -2.174 -8.131z
                lineToRelative(dx = -2.174f, dy = -8.131f)
                close()
                // M 10.98 9.3
                moveTo(x = 10.98f, y = 9.3f)
                // c 0.047 -0.315 0.43 -0.495 0.83 -0.388
                curveToRelative(
                    dx1 = 0.047f,
                    dy1 = -0.315f,
                    dx2 = 0.43f,
                ...
                // l -1.027 2.608
                lineToRelative(dx = -1.027f, dy = 2.608f)
                // l -0.74 -0.198
                lineToRelative(dx = -0.74f, dy = -0.198f)
                // l 0.414 -2.773z
                lineToRelative(dx = 0.414f, dy = -2.773f)
                close()
                // m 0.212 4.105
                moveToRelative(dx = 0.212f, dy = 4.105f)
                // a 0.563 0.563 0 1 1 -1.086 -0.291
                arcToRelative(
                    a = 0.563f,
                    b = 0.563f,
                    theta = 0.0f,
                ...
                // a 0.563 0.563 0 0 1 1.086 0.291z
                arcToRelative(
                    a = 0.563f,
                    b = 0.563f,
                    theta = 0.0f,
        ...
        }.build().also { _ic2345 = it }
    }

@Suppress("ObjectPropertyName")
private var _ic2345: ImageVector? = null
