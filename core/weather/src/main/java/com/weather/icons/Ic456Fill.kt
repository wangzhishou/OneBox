...
val QWeatherIcons.Ic456Fill: ImageVector
    get() {
        val current = _ic456Fill
        if (current != null) return current

        return ImageVector.Builder(
            name = "QWeather.Ic456Fill",
            defaultWidth = 16.0.dp,
            defaultHeight = 16.0.dp,
            viewportWidth = 16.0f,
            viewportHeight = 16.0f,
        ).apply {
            // M3.57 15 a1 1 0 1 0 2 0 c0 -.5 -.555 -1.395 -1 -2 -.445 .605 -1 1.5 -1 2Z m6.501 -2 a.35 .35 0 0 0 -.35 .35 v.544 l-.47 -.272 a.35 .35 0 1 0 -.35 .606 l.47 .272 -.47 .272 a.35 .35 0 1 0 .35 .606 l.47 -.272 v.544 a.35 .35 0 0 0 .7 0 v-.544 l.47 .272 a.35 .35 0 1 0 .35 -.606 l-.47 -.272 .47 -.272 a.35 .35 0 1 0 -.35 -.606 l-.47 .272 v-.544 a.35 .35 0 0 0 -.35 -.35Z m.923 -2.104 A4.758 4.758 0 0 1 7.406 12.5 a4.76 4.76 0 0 1 -3.537 -1.547 2.908 2.908 0 0 1 -1.057 .197 C1.26 11.15 0 9.941 0 8.45 s1.26 -2.7 2.813 -2.7 c.173 0 .342 .015 .507 .044 C4.124 4.424 5.652 3.5 7.406 3.5 c1.769 0 3.308 .94 4.107 2.328 a2.93 2.93 0 0 1 .675 -.078 C13.74 5.75 15 6.959 15 8.45 s-1.26 2.7 -2.813 2.7 a2.9 2.9 0 0 1 -1.193 -.254Z m4.472 -6.681 a.31 .31 0 0 0 -.08 .01 3.066 3.066 0 0 1 -1.866 -.076 A3.183 3.183 0 0 1 11.492 .364 .29 .29 0 0 0 11.22 0 a.28 .28 0 0 0 -.104 .02 3.546 3.546 0 0 0 -2.21 3.096 c.34 .063 .671 .16 .99 .293 a2.56 2.56 0 0 1 .54 -1.671 4.166 4.166 0 0 0 2.755 3.356 c.274 .096 .558 .164 .846 .203 a2.611 2.611 0 0 1 -.239 .163 c.304 .173 .582 .39 .823 .643 a3.553 3.553 0 0 0 1.12 -1.504 .285 .285 0 0 0 -.275 -.384Z
            path(
                ...
                close()
                // m 0.923 -2.104
                moveToRelative(dx = 0.923f, dy = -2.104f)
        ...
        }.build().also { _ic456Fill = it }
    }

@Suppress("ObjectPropertyName")
private var _ic456Fill: ImageVector? = null
