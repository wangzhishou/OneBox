...
val QWeatherIcons.Ic2353: ImageVector
    get() {
        val current = _ic2353
        if (current != null) return current

        return ImageVector.Builder(
            name = "QWeather.Ic2353",
        ...
        }.build().also { _ic2353 = it }
    }

@Suppress("ObjectPropertyName")
private var _ic2353: ImageVector? = null
