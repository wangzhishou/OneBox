...
val QWeatherIcons.Ic307: ImageVector
    get() {
        val current = _ic307
        ...
        }.build().also { _ic307 = it }
    }

@Suppress("ObjectPropertyName")
private var _ic307: ImageVector? = null
