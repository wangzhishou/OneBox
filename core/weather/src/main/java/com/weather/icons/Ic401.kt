...
val QWeatherIcons.Ic401: ImageVector
    get() {
        val current = _ic401
        ...
        }.build().also { _ic401 = it }
    }

@Suppress("ObjectPropertyName")
private var _ic401: ImageVector? = null
