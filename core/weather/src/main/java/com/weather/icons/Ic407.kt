...
val QWeatherIcons.Ic407: ImageVector
    get() {
        val current = _ic407
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                close()
                // m -2.59 -0.5
                moveToRelative(dx = -2.59f, dy = -0.5f)
                ...
                close()
                // m -6.872 -7.99
                moveToRelative(dx = -6.872f, dy = -7.99f)
                // h 0.007
        ...
        }.build().also { _ic407 = it }
    }

@Suppress("ObjectPropertyName")
private var _ic407: ImageVector? = null
