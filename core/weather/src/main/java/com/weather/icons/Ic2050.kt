...
val QWeatherIcons.Ic2050: ImageVector
    get() {
        val current = _ic2050
        if (current != null) return current

        return ImageVector.Builder(
            name = "QWeather.Ic2050",
            defaultWidth = 16.0.dp,
            defaultHeight = 16.0.dp,
            viewportWidth = 16.0f,
            viewportHeight = 16.0f,
        ).apply {
            // M7.9 10 a4.99 4.99 0 0 0 3.827 -1.783 3 3 0 1 0 .553 -5.63 A4.999 4.999 0 0 0 7.9 0 a4.998 4.998 0 0 0 -4.359 2.549 3 3 0 1 0 .586 5.732 A4.988 4.988 0 0 0 7.9 10Z m-.791 -6.398 c-.057 -.362 .17 -.8 .496 -.997 .256 -.153 .551 -.133 .806 .023 l.07 .042 a.846 .846 0 0 1 .409 .853 L8.532 5.8 H7.454 L7.11 3.602Z M8.599 6.9 a.6 .6 0 1 1 -1.2 0 .6 .6 0 0 1 1.2 0Z m-2.813 4.163 c.205 .13 .275 .416 .157 .64 L3.8 15.766 c-.119 .225 -.38 .302 -.586 .172 a.494 .494 0 0 1 -.157 -.64 L5.2 11.234 c.119 -.225 .38 -.302 .586 -.172Z M2.8 11.056 c.191 .115 .257 .37 .146 .57 l-1.2 2.165 a.391 .391 0 0 1 -.546 .153 .427 .427 0 0 1 -.146 -.57 l1.2 -2.165 a.39 .39 0 0 1 .546 -.153Z m6 0 c.191 .115 .257 .37 .146 .57 l-1.2 2.165 a.391 .391 0 0 1 -.546 .153 .427 .427 0 0 1 -.146 -.57 l1.2 -2.165 a.39 .39 0 0 1 .546 -.153Z m6.146 .569 a.427 .427 0 0 0 -.146 -.57 .391 .391 0 0 0 -.546 .154 l-1.2 2.166 a.428 .428 0 0 0 .146 .57 .391 .391 0 0 0 .546 -.154 l1.2 -2.166Z m-3.003 .079 a.494 .494 0 0 0 -.157 -.641 c-.205 -.13 -.467 -.053 -.586 .172 l-2.143 4.061 a.494 .494 0 0 0 .157 .641 c.205 .13 .467 .053 .586 -.172 l2.143 -4.061Z
            path(
                ...
                close()
                // m -2.813 4.163
                moveToRelative(dx = -2.813f, dy = 4.163f)
                ...
                close()
                // m 6.146 0.569
                moveToRelative(dx = 6.146f, dy = 0.569f)
                ...
                close()
                // m -3.003 0.079
                moveToRelative(dx = -3.003f, dy = 0.079f)
        ...
        }.build().also { _ic2050 = it }
    }

@Suppress("ObjectPropertyName")
private var _ic2050: ImageVector? = null
