...
val QWeatherIcons.Ic1051: ImageVector
    get() {
        val current = _ic1051
        if (current != null) return current

        return ImageVector.Builder(
            name = "QWeather.Ic1051",
            ...
            // M10.5 4.23 a.75 .75 0 1 1 -1.5 0 .75 .75 0 0 1 1.5 0Z m1.524 2.116 a.5 .5 0 1 0 0 -1 .5 .5 0 0 0 0 1Z m1.454 -2.199 a.5 .5 0 1 1 -1 0 .5 .5 0 0 1 1 0Z M6.5 12 a.5 .5 0 1 0 0 -1 .5 .5 0 0 0 0 1Z m8.5 -.5 a.5 .5 0 1 1 -1 0 .5 .5 0 0 1 1 0Z M4.5 11 a.5 .5 0 1 0 0 -1 .5 .5 0 0 0 0 1Z m-2 3 a.5 .5 0 1 1 -1 0 .5 .5 0 0 1 1 0Z m-.75 -2.5 a.75 .75 0 1 0 0 -1.5 .75 .75 0 0 0 0 1.5Z m13 2.293 a.75 .75 0 1 1 -1.5 0 .75 .75 0 0 1 1.5 0Z M2 6 a1 1 0 1 0 0 -2 1 1 0 0 0 0 2Z
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 10.5 4.23
                moveTo(x = 10.5f, y = 4.23f)
                ...
                close()
                // m 1.524 2.116
                moveToRelative(dx = 1.524f, dy = 2.116f)
                // a 0.5 0.5 0 1 0 0 -1
                arcToRelative(
                    a = 0.5f,
                    b = 0.5f,
                ...
                close()
                // m 1.454 -2.199
                moveToRelative(dx = 1.454f, dy = -2.199f)
                // a 0.5 0.5 0 1 1 -1 0
                arcToRelative(
                    a = 0.5f,
                    b = 0.5f,
                ...
                close()
                // m -0.75 -2.5
                moveToRelative(dx = -0.75f, dy = -2.5f)
                ...
                close()
                // m 13 2.293
                moveToRelative(dx = 13.0f, dy = 2.293f)
                // a 0.75 0.75 0 1 1 -1.5 0
                arcToRelative(
                    a = 0.75f,
                    b = 0.75f,
        ...
        }.build().also { _ic1051 = it }
    }

@Suppress("ObjectPropertyName")
private var _ic1051: ImageVector? = null
