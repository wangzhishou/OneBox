...
val QWeatherIcons.Ic313: ImageVector
    get() {
        val current = _ic313
        ...
        return ImageVector.Builder(
            ...
            // M7.9 10 c1.453 0 2.761 -.62 3.675 -1.61 a.335 .335 0 0 1 .365 -.083 3 3 0 1 0 .566 -5.767 .335 .335 0 0 1 -.341 -.152 A4.997 4.997 0 0 0 7.9 0 a4.997 4.997 0 0 0 -4.25 2.365 .334 .334 0 0 1 -.32 .153 3 3 0 1 0 .596 5.836 .334 .334 0 0 1 .345 .086 A4.99 4.99 0 0 0 7.9 10Z m3.905 -2.896 c-.172 -.129 -.438 -.097 -.555 .083 A3.997 3.997 0 0 1 7.9 9 a3.996 3.996 0 0 1 -3.297 -1.734 c-.112 -.163 -.347 -.197 -.513 -.089 a2 2 0 1 1 -.362 -3.54 c.184 .072 .408 -.01 .485 -.192 a4.001 4.001 0 0 1 7.398 .059 c.08 .2 .335 .282 .53 .19 a2 2 0 1 1 -.335 3.41Z M1 9 l1 1.5 L1 12 l-1 -1.5 L1 9Z m15 1.5 L15 9 l-1 1.5 1 1.5 1 -1.5Z m-7 4 L8 13 l-1 1.5 L8 16 l1 -1.5Z M4.5 11 l1 1.5 -1 1.5 -1 -1.5 1 -1.5Z m8 1.5 -1 -1.5 -1 1.5 1 1.5 1 -1.5Z
            path(
        ...
        }.build().also { _ic313 = it }
    }

@Suppress("ObjectPropertyName")
private var _ic313: ImageVector? = null
