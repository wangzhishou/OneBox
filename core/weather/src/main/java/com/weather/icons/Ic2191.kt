...
val QWeatherIcons.Ic2191: ImageVector
    get() {
        val current = _ic2191
        if (current != null) return current

        return ImageVector.Builder(
            name = "QWeather.Ic2191",
            ...
            path(
                ...
                close()
                // M 8.288 8
                moveTo(x = 8.288f, y = 8.0f)
                // l 2.852 3.802
                lineToRelative(dx = 2.852f, dy = 3.802f)
                // l 0.905 -2.716
                lineToRelative(dx = 0.905f, dy = -2.716f)
                // l 3.419 2.28
                lineToRelative(dx = 3.419f, dy = 2.28f)
                // H 13.12
                horizontalLineTo(x = 13.12f)
                // l -1.723 3.447
                lineToRelative(dx = -1.723f, dy = 3.447f)
                // l -3 -4
                lineToRelative(dx = -3.0f, dy = -4.0f)
                // l -1.415 2.83
                lineToRelative(dx = -1.415f, dy = 2.83f)
                // L 4 11.255
                lineTo(x = 4.0f, y = 11.255f)
                // l 0.536 -0.838
                lineToRelative(dx = 0.536f, dy = -0.838f)
                // l 1.605 0.803
                lineToRelative(dx = 1.605f, dy = 0.803f)
                // L 8.288 8z
                lineTo(x = 8.288f, y = 8.0f)
                close()
            }
        }.build().also { _ic2191 = it }
    }

@Suppress("ObjectPropertyName")
private var _ic2191: ImageVector? = null
