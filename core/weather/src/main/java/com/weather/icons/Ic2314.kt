...
val QWeatherIcons.Ic2314: ImageVector
    get() {
        val current = _ic2314
        if (current != null) return current

        return ImageVector.Builder(
            name = "QWeather.Ic2314",
            defaultWidth = 16.0.dp,
            defaultHeight = 16.0.dp,
            viewportWidth = 16.0f,
            viewportHeight = 16.0f,
        ).apply {
            // M7.502 6.42 C7.476 6.193 7.707 6 8 6 c.293 0 .524 .194 .498 .42 L8.273 8.4 h-.546 l-.225 -1.98Z m.901 2.78 a.4 .4 0 1 1 -.8 0 .4 .4 0 0 1 .8 0Z
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 7.502 6.42
                moveTo(x = 7.502f, y = 6.42f)
                // C 7.476 6.193 7.707 6 8 6
                curveTo(
                    x1 = 7.476f,
                    y1 = 6.193f,
                    x2 = 7.707f,
            ...
            path(
                ...
                close()
                // m 0.38 2.358
                moveToRelative(dx = 0.38f, dy = 2.358f)
                ...
                // L 7.83 4.973z
                lineTo(x = 7.83f, y = 4.973f)
                close()
            }
        }.build().also { _ic2314 = it }
    }

@Suppress("ObjectPropertyName")
private var _ic2314: ImageVector? = null
