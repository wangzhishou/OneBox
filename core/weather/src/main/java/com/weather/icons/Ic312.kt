...
val QWeatherIcons.Ic312: ImageVector
    get() {
        val current = _ic312
        ...
        }.build().also { _ic312 = it }
    }

@Suppress("ObjectPropertyName")
private var _ic312: ImageVector? = null
