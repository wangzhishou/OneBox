...
val QWeatherIcons.Ic350: ImageVector
    get() {
        val current = _ic350
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                close()
                // m -2.094 -2.5
                moveToRelative(dx = -2.094f, dy = -2.5f)
        ...
        }.build().also { _ic350 = it }
    }

@Suppress("ObjectPropertyName")
private var _ic350: ImageVector? = null
