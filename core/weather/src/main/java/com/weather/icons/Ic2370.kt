...
val QWeatherIcons.Ic2370: ImageVector
    get() {
        val current = _ic2370
        if (current != null) return current

        return ImageVector.Builder(
            name = "QWeather.Ic2370",
        ...
        }.build().also { _ic2370 = it }
    }

@Suppress("ObjectPropertyName")
private var _ic2370: ImageVector? = null
