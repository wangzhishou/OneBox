...
val QWeatherIcons.Ic2130: ImageVector
    get() {
        val current = _ic2130
        if (current != null) return current

        return ImageVector.Builder(
            name = "QWeather.Ic2130",
            defaultWidth = 16.0.dp,
            defaultHeight = 16.0.dp,
            viewportWidth = 16.0f,
            viewportHeight = 16.0f,
        ).apply {
            // M8.375 .375 a.375 .375 0 1 0 -.75 0 v.97 L7.14 .86 a.375 .375 0 1 0 -.53 .53 l1.015 1.015 V3.75 l.001 .03 a2.248 2.248 0 0 0 -1.36 .787 .378 .378 0 0 0 -.027 -.017 l-1.165 -.672 -.371 -1.387 a.375 .375 0 1 0 -.725 .194 l.178 .663 -.84 -.485 a.375 .375 0 1 0 -.375 .65 l.84 .484 -.662 .178 a.375 .375 0 0 0 .194 .724 l1.386 -.372 1.165 .673 a.38 .38 0 0 0 .027 .014 2.245 2.245 0 0 0 0 1.572 .377 .377 0 0 0 -.027 .014 l-1.165 .673 L3.313 7.1 a.375 .375 0 1 0 -.194 .724 l.662 .178 -.84 .485 a.375 .375 0 1 0 .375 .65 l.84 -.486 -.178 .663 a.375 .375 0 0 0 .725 .194 l.371 -1.387 L6.24 7.45 a.382 .382 0 0 0 .026 -.017 c.338 .408 .816 .695 1.361 .786 a.38 .38 0 0 0 0 .031 v1.345 L6.61 10.61 a.375 .375 0 0 0 .53 .53 l.485 -.485 v.97 a.375 .375 0 0 0 .75 0 v-.97 l.485 .485 a.375 .375 0 0 0 .53 -.53 L8.375 9.595 V8.25 l-.001 -.03 a2.248 2.248 0 0 0 1.36 -.787 .383 .383 0 0 0 .027 .017 l1.165 .672 .371 1.387 a.375 .375 0 0 0 .725 -.194 l-.178 -.663 .84 .485 a.375 .375 0 1 0 .375 -.65 l-.84 -.484 .663 -.178 a.375 .375 0 0 0 -.195 -.724 l-1.386 .372 -1.165 -.673 a.364 .364 0 0 0 -.027 -.014 2.246 2.246 0 0 0 0 -1.572 .364 .364 0 0 0 .027 -.014 l1.165 -.673 1.386 .372 a.375 .375 0 0 0 .195 -.724 l-.663 -.178 .84 -.485 a.375 .375 0 0 0 -.375 -.65 l-.84 .486 .178 -.663 a.375 .375 0 1 0 -.725 -.194 l-.371 1.387 -1.165 .672 a.378 .378 0 0 0 -.026 .017 2.248 2.248 0 0 0 -1.361 -.786 l.001 -.031 V2.405 L9.39 1.39 a.375 .375 0 0 0 -.53 -.53 l-.485 .485 v-.97Z M2.5 13 a.5 .5 0 0 0 0 1 h11 a.5 .5 0 0 0 0 -1 h-11Z m-2 2 a.5 .5 0 0 0 0 1 h15 a.5 .5 0 0 0 0 -1 H.5Z
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 8.375 0.375
                moveTo(x = 8.375f, y = 0.375f)
                ...
                // l -0.178 0.663
                lineToRelative(dx = -0.178f, dy = 0.663f)
                // a 0.375 0.375 0 0 0 0.725 0.194
                arcToRelative(
                    a = 0.375f,
                    b = 0.375f,
                    theta = 0.0f,
                ...
                // V 2.405
                verticalLineTo(y = 2.405f)
                // L 9.39 1.39
                lineTo(x = 9.39f, y = 1.39f)
                // a 0.375 0.375 0 0 0 -0.53 -0.53
                arcToRelative(
                    a = 0.375f,
                    b = 0.375f,
        ...
        }.build().also { _ic2130 = it }
    }

@Suppress("ObjectPropertyName")
private var _ic2130: ImageVector? = null
