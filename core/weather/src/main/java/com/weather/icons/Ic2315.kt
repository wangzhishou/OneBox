...
val QWeatherIcons.Ic2315: ImageVector
    get() {
        val current = _ic2315
        if (current != null) return current

        return ImageVector.Builder(
            name = "QWeather.Ic2315",
            defaultWidth = 16.0.dp,
            defaultHeight = 16.0.dp,
            viewportWidth = 16.0f,
            viewportHeight = 16.0f,
        ).apply {
            // M11.756 7.71 a.296 .296 0 0 0 -.512 0 L7.04 15 a.292 .292 0 0 0 .256 .438 h8.41 a.292 .292 0 0 0 .256 -.437 L11.756 7.71Z m-.956 2.41 c-.036 -.317 .287 -.59 .7 -.59 .412 0 .736 .273 .7 .59 l-.316 2.785 h-.768 L10.8 10.12Z m1.267 3.91 a.563 .563 0 1 1 -1.125 0 .563 .563 0 0 1 1.125 0Z M2.5 1.866 a1 1 0 1 0 -1 0 V15 H0 v1 h4 v-1 H2.5 V4.292 l2.13 1.277 c.046 -.129 .105 -.298 .161 -.486 L2.986 4 4.79 2.917 a9.43 9.43 0 0 0 -.162 -.486 L2.5 3.708 V1.866Z
            path(
        ...
        }.build().also { _ic2315 = it }
    }

@Suppress("ObjectPropertyName")
private var _ic2315: ImageVector? = null
