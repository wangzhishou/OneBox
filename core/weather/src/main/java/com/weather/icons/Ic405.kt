...
val QWeatherIcons.Ic405: ImageVector
    get() {
        val current = _ic405
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                close()
                // m 5.151 -1.65
                moveToRelative(dx = 5.151f, dy = -1.65f)
        ...
        }.build().also { _ic405 = it }
    }

@Suppress("ObjectPropertyName")
private var _ic405: ImageVector? = null
