...
val QWeatherIcons.Ic306: ImageVector
    get() {
        val current = _ic306
        ...
        return ImageVector.Builder(
            ...
            // M2.293 13.707 A1 1 0 0 1 2 13 c0 -.5 .555 -1.395 1 -2 .445 .605 1 1.5 1 2 a1 1 0 0 1 -1.707 .707Z m10 0 A1 1 0 0 1 12 13 c0 -.5 .555 -1.395 1 -2 .445 .605 1 1.5 1 2 a1 1 0 0 1 -1.707 .707Z M7 15 a1 1 0 1 0 2 0 c0 -.5 -.555 -1.395 -1 -2 -.445 .605 -1 1.5 -1 2Z m.9 -5 c1.453 0 2.761 -.62 3.675 -1.61 a.335 .335 0 0 1 .365 -.083 3 3 0 1 0 .566 -5.767 .335 .335 0 0 1 -.341 -.152 A4.997 4.997 0 0 0 7.9 0 a4.997 4.997 0 0 0 -4.25 2.365 .334 .334 0 0 1 -.32 .153 3 3 0 1 0 .596 5.836 .334 .334 0 0 1 .345 .086 A4.99 4.99 0 0 0 7.9 10Z m3.905 -2.896 c-.172 -.129 -.438 -.097 -.555 .083 A3.997 3.997 0 0 1 7.9 9 a3.996 3.996 0 0 1 -3.297 -1.734 c-.112 -.163 -.347 -.197 -.513 -.089 a2 2 0 1 1 -.362 -3.54 c.184 .072 .408 -.01 .485 -.192 a4.001 4.001 0 0 1 7.398 .059 c.08 .2 .335 .282 .53 .19 a2 2 0 1 1 -.335 3.41Z
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 2.293 13.707
                moveTo(x = 2.293f, y = 13.707f)
                // A 1 1 0 0 1 2 13
                arcTo(
                ...
                close()
                // m 0.9 -5
                moveToRelative(dx = 0.9f, dy = -5.0f)
        ...
        }.build().also { _ic306 = it }
    }

@Suppress("ObjectPropertyName")
private var _ic306: ImageVector? = null
