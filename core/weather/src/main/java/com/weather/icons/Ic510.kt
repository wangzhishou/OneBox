...
val QWeatherIcons.Ic510: ImageVector
    get() {
        val current = _ic510
        ...
        }.build().also { _ic510 = it }
    }

@Suppress("ObjectPropertyName")
private var _ic510: ImageVector? = null
