...
val QWeatherIcons.Ic2355: ImageVector
    get() {
        val current = _ic2355
        if (current != null) return current

        return ImageVector.Builder(
            name = "QWeather.Ic2355",
            ...
            // M5.698 2.464 c.346 -.015 .8 -.032 1.302 -.042 V5.01 c-.46 .1 -.882 .198 -1.227 .281 l.048 -.171 C5.914 4.775 6 4.364 6 4 c0 -.383 -.096 -.82 -.195 -1.18 a9.243 9.243 0 0 0 -.107 -.356Z M8 2.414 c.509 .002 1.026 .015 1.5 .047 v2.094 c-.477 .063 -.992 .151 -1.5 .25 V2.413Z m2.5 .15 c.478 .067 .995 .159 1.5 .26 v1.59 a26.44 26.44 0 0 0 -1.5 .045 V2.564Z m2.5 .47 c.62 .137 1.16 .27 1.5 .354 v1.084 c-.368 -.017 -.9 -.039 -1.5 -.05 V3.034Z M5.11 1.493 a.601 .601 0 0 0 -.527 .814 c.06 .159 .167 .454 .258 .781 .093 .337 .159 .668 .159 .912 0 .23 -.058 .54 -.145 .86 a9.06 9.06 0 0 1 -.251 .778 c-.166 .444 .23 .92 .713 .796 .706 -.18 3.118 -.775 4.733 -.936 1.693 -.17 4.26 -.037 4.817 -.005 a.6 .6 0 0 0 .633 -.6 V3.077 a.6 .6 0 0 0 -.449 -.58 c-.47 -.122 -3.184 -.813 -5.001 -.995 -1.75 -.175 -4.328 -.044 -4.94 -.01Z M11.5 16 a4.5 4.5 0 1 0 0 -9 4.5 4.5 0 0 0 0 9Z m-.7 -6.441 c-.036 -.317 .287 -.59 .7 -.59 .412 0 .736 .273 .7 .59 l-.316 2.785 h-.768 L10.8 9.559Z m1.267 3.91 a.563 .563 0 1 1 -1.125 0 .563 .563 0 0 1 1.125 0Z
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 5.698 2.464
                ...
                close()
                // m -0.7 -6.441
                moveToRelative(dx = -0.7f, dy = -6.441f)
        ...
        }.build().also { _ic2355 = it }
    }

@Suppress("ObjectPropertyName")
private var _ic2355: ImageVector? = null
