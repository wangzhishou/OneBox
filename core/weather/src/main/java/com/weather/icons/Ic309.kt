...
val QWeatherIcons.Ic309: ImageVector
    get() {
        val current = _ic309
        ...
        }.build().also { _ic309 = it }
    }

@Suppress("ObjectPropertyName")
private var _ic309: ImageVector? = null
