...
val QWeatherIcons.Ic2384: ImageVector
    get() {
        val current = _ic2384
        if (current != null) return current

        return ImageVector.Builder(
            name = "QWeather.Ic2384",
            ...
            // M5.698 2.464 c.346 -.015 .8 -.032 1.302 -.042 V5.01 c-.46 .1 -.882 .198 -1.227 .281 l.048 -.171 C5.914 4.775 6 4.364 6 4 c0 -.383 -.096 -.82 -.195 -1.18 a9.243 9.243 0 0 0 -.107 -.356Z M8 2.414 c.509 .002 1.026 .015 1.5 .047 v2.094 c-.477 .063 -.992 .151 -1.5 .25 V2.413Z m2.5 .15 c.478 .067 .995 .159 1.5 .26 v1.59 a26.44 26.44 0 0 0 -1.5 .045 V2.564Z m2.5 .47 c.62 .137 1.16 .27 1.5 .354 v1.084 c-.368 -.017 -.9 -.039 -1.5 -.05 V3.034Z M5.11 1.493 a.601 .601 0 0 0 -.527 .814 c.06 .159 .167 .454 .258 .781 .093 .337 .159 .668 .159 .912 0 .23 -.058 .54 -.145 .86 a9.06 9.06 0 0 1 -.251 .778 c-.166 .444 .23 .92 .713 .796 .706 -.18 3.118 -.775 4.733 -.936 1.693 -.17 4.26 -.037 4.817 -.005 a.6 .6 0 0 0 .633 -.6 V3.077 a.6 .6 0 0 0 -.449 -.58 c-.47 -.122 -3.184 -.813 -5.001 -.995 -1.75 -.175 -4.328 -.044 -4.94 -.01Z m5.94 8.087 c.05 -.299 .368 -.482 .687 -.396 .318 .085 .502 .402 .396 .686 l-.93 2.49 -.593 -.159 .44 -2.621Z m.039 3.652 a.422 .422 0 1 1 -.815 -.218 .422 .422 0 0 1 .815 .218Z
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 5.698 2.464
                ...
                close()
                // m 5.94 8.087
                moveToRelative(dx = 5.94f, dy = 8.087f)
                // c 0.05 -0.299 0.368 -0.482 0.687 -0.396
                curveToRelative(
                    dx1 = 0.05f,
                    dy1 = -0.299f,
                    dx2 = 0.368f,
                ...
                // c 0.318 0.085 0.502 0.402 0.396 0.686
                curveToRelative(
                    dx1 = 0.318f,
                    dy1 = 0.085f,
                    dx2 = 0.502f,
                ...
                // l -0.93 2.49
                lineToRelative(dx = -0.93f, dy = 2.49f)
                // l -0.593 -0.159
                lineToRelative(dx = -0.593f, dy = -0.159f)
                // l 0.44 -2.621z
                lineToRelative(dx = 0.44f, dy = -2.621f)
                close()
                // m 0.039 3.652
                moveToRelative(dx = 0.039f, dy = 3.652f)
                // a 0.422 0.422 0 1 1 -0.815 -0.218
                arcToRelative(
                    a = 0.422f,
                    b = 0.422f,
                    theta = 0.0f,
                ...
                // a 0.422 0.422 0 0 1 0.815 0.218z
                arcToRelative(
                    a = 0.422f,
                    b = 0.422f,
                    theta = 0.0f,
            ...
            // M12.034 7.086 a.296 .296 0 0 1 .494 .133 l2.175 8.13 a.292 .292 0 0 1 -.36 .356 L6.218 13.53 a.292 .292 0 0 1 -.134 -.488 l5.949 -5.955Z m1.845 7.796 L12.046 8.03 l-5.014 5.019 6.847 1.834Z
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 12.034 7.086
                moveTo(x = 12.034f, y = 7.086f)
                // a 0.296 0.296 0 0 1 0.494 0.133
                arcToRelative(
                    a = 0.296f,
                    b = 0.296f,
                    theta = 0.0f,
                ...
                // l 2.175 8.13
                lineToRelative(dx = 2.175f, dy = 8.13f)
                // a 0.292 0.292 0 0 1 -0.36 0.356
                arcToRelative(
                    a = 0.292f,
                    b = 0.292f,
                    theta = 0.0f,
                ...
                // L 6.218 13.53
                lineTo(x = 6.218f, y = 13.53f)
                // a 0.292 0.292 0 0 1 -0.134 -0.488
                arcToRelative(
                    a = 0.292f,
                    b = 0.292f,
                    theta = 0.0f,
                ...
                // l 5.949 -5.955z
                lineToRelative(dx = 5.949f, dy = -5.955f)
                close()
                // m 1.845 7.796
                moveToRelative(dx = 1.845f, dy = 7.796f)
                // L 12.046 8.03
                lineTo(x = 12.046f, y = 8.03f)
                // l -5.014 5.019
                lineToRelative(dx = -5.014f, dy = 5.019f)
                // l 6.847 1.834z
                lineToRelative(dx = 6.847f, dy = 1.834f)
                close()
            }
        }.build().also { _ic2384 = it }
    }

@Suppress("ObjectPropertyName")
private var _ic2384: ImageVector? = null
