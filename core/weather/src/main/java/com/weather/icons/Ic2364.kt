...
val QWeatherIcons.Ic2364: ImageVector
    get() {
        val current = _ic2364
        if (current != null) return current

        return ImageVector.Builder(
            name = "QWeather.Ic2364",
            defaultWidth = 16.0.dp,
            defaultHeight = 16.0.dp,
            viewportWidth = 16.0f,
            viewportHeight = 16.0f,
        ).apply {
            // M13 16 a3 3 0 1 0 0 -6 3 3 0 0 0 0 6Z m-.467 -4.294 c-.024 -.212 .192 -.393 .467 -.393 s.491 .181 .467 .393 l-.211 1.857 h-.512 l-.21 -1.857Z m.845 2.607 a.375 .375 0 1 1 -.75 0 .375 .375 0 0 1 .75 0Z M1 0 H0 v16 h1 V7.752 c.75 .836 2 1.135 4.703 .431 C8.228 7.525 11 9 11 9 V1.81 C8.12 .65 6.717 1.003 4.57 1.54 l-.303 .075 C1.945 2.193 1 1 1 1 V0Z m3 3 4 -.5 v4 L4 7 V3Z
            path(
        ...
        }.build().also { _ic2364 = it }
    }

@Suppress("ObjectPropertyName")
private var _ic2364: ImageVector? = null
