...
val QWeatherIcons.Ic317Fill: ImageVector
    get() {
        val current = _ic317Fill
        if (current != null) return current

        return ImageVector.Builder(
            name = "QWeather.Ic317Fill",
            defaultWidth = 16.0.dp,
            defaultHeight = 16.0.dp,
            viewportWidth = 16.0f,
            viewportHeight = 16.0f,
        ).apply {
            // M2 8.5 a.5 .5 0 0 1 1 0 v2 a.5 .5 0 0 1 -1 0 v-2Z m8 0 a.5 .5 0 0 1 1 0 v2 a.5 .5 0 0 1 -1 0 v-2Z M5.5 8 a.5 .5 0 0 0 -.5 .5 v2 a.5 .5 0 0 0 1 0 v-2 a.5 .5 0 0 0 -.5 -.5Z m6.5 .5 a.5 .5 0 0 1 1 0 v2 a.5 .5 0 0 1 -1 0 v-2Z m2.5 -.5 a.5 .5 0 0 0 -.5 .5 v2 a.5 .5 0 0 0 1 0 v-2 a.5 .5 0 0 0 -.5 -.5Z M5 12.5 a.5 .5 0 0 1 1 0 v2 a.5 .5 0 0 1 -1 0 v-2Z m8.5 -.5 a.5 .5 0 0 0 -.5 .5 v2 a.5 .5 0 0 0 1 0 v-2 a.5 .5 0 0 0 -.5 -.5Z M2 12.5 a.5 .5 0 0 1 1 0 v2 a.5 .5 0 0 1 -1 0 v-2Z m9.5 -.5 a.5 .5 0 0 0 -.5 .5 v2 a.5 .5 0 0 0 1 0 v-2 a.5 .5 0 0 0 -.5 -.5Z
            path(
                ...
                close()
                // m 6.5 0.5
                moveToRelative(dx = 6.5f, dy = 0.5f)
                // a 0.5 0.5 0 0 1 1 0
                arcToRelative(
                    a = 0.5f,
                    b = 0.5f,
                ...
                close()
                // m 8.5 -0.5
                moveToRelative(dx = 8.5f, dy = -0.5f)
                // a 0.5 0.5 0 0 0 -0.5 0.5
                arcToRelative(
                    a = 0.5f,
                    b = 0.5f,
                ...
                close()
                // m 9.5 -0.5
                moveToRelative(dx = 9.5f, dy = -0.5f)
                // a 0.5 0.5 0 0 0 -0.5 0.5
                arcToRelative(
                    a = 0.5f,
                    b = 0.5f,
        ...
        }.build().also { _ic317Fill = it }
    }

@Suppress("ObjectPropertyName")
private var _ic317Fill: ImageVector? = null
