...
val QWeatherIcons.Ic2348: ImageVector
    get() {
        val current = _ic2348
        if (current != null) return current

        return ImageVector.Builder(
            name = "QWeather.Ic2348",
            ...
            // M12.17 8.473 a.197 .197 0 0 0 -.34 0 l-2.804 4.86 c-.075 .13 .02 .292 .17 .292 h5.607 a.194 .194 0 0 0 .17 -.291 L12.17 8.473Z m-.637 1.608 c-.024 -.212 .192 -.393 .467 -.393 s.491 .181 .467 .393 l-.211 1.857 h-.512 l-.21 -1.857Z m.845 2.607 a.375 .375 0 1 1 -.75 0 .375 .375 0 0 1 .75 0Z
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 12.17 8.473
                moveTo(x = 12.17f, y = 8.473f)
        ...
        }.build().also { _ic2348 = it }
    }

@Suppress("ObjectPropertyName")
private var _ic2348: ImageVector? = null
