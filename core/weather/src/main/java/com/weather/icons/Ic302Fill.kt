    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                close()
                // m -2.54 -0.374
                moveToRelative(dx = -2.54f, dy = -0.374f)
        ...
        }.build().also { _ic302Fill = it }
    }

@Suppress("ObjectPropertyName")
private var _ic302Fill: ImageVector? = null
