...
val QWeatherIcons.Ic406: ImageVector
    get() {
        val current = _ic406
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                close()
                // m -2.67 -0.5
                moveToRelative(dx = -2.67f, dy = -0.5f)
        ...
        }.build().also { _ic406 = it }
    }

@Suppress("ObjectPropertyName")
private var _ic406: ImageVector? = null
