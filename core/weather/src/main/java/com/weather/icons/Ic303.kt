...
val QWeatherIcons.Ic303: ImageVector
    get() {
        val current = _ic303
        ...
        }.build().also { _ic303 = it }
    }

@Suppress("ObjectPropertyName")
private var _ic303: ImageVector? = null
