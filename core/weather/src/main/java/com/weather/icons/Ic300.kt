...
val QWeatherIcons.Ic300: ImageVector
    get() {
        val current = _ic300
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                close()
                // m -2.094 -1.5
                moveToRelative(dx = -2.094f, dy = -1.5f)
        ...
        }.build().also { _ic300 = it }
    }

@Suppress("ObjectPropertyName")
private var _ic300: ImageVector? = null
