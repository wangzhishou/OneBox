...
val QWeatherIcons.Ic410: ImageVector
    get() {
        val current = _ic410
        ...
        }.build().also { _ic410 = it }
    }

@Suppress("ObjectPropertyName")
private var _ic410: ImageVector? = null
