...
val QWeatherIcons.Ic316Fill: ImageVector
    get() {
        val current = _ic316Fill
        if (current != null) return current

        return ImageVector.Builder(
            name = "QWeather.Ic316Fill",
            defaultWidth = 16.0.dp,
            defaultHeight = 16.0.dp,
            viewportWidth = 16.0f,
            viewportHeight = 16.0f,
        ).apply {
            // M1.293 10.707 A1 1 0 0 1 1 10 c0 -.5 .555 -1.395 1 -2 .445 .605 1 1.5 1 2 a1 1 0 0 1 -1.707 .707Z m8 0 A1 1 0 0 1 9 10 c0 -.5 .555 -1.395 1 -2 .445 .605 1 1.5 1 2 a1 1 0 0 1 -1.707 .707Z m2.5 0 A1 1 0 0 1 11.5 10 c0 -.5 .555 -1.395 1 -2 .445 .605 1 1.5 1 2 a1 1 0 0 1 -1.707 .707Z M14 10 a1 1 0 0 0 2 0 c0 -.5 -.555 -1.395 -1 -2 -.445 .605 -1 1.5 -1 2Z m-.707 4.707 A1 1 0 0 1 13 14 c0 -.5 .555 -1.395 1 -2 .445 .605 1 1.5 1 2 a1 1 0 0 1 -1.707 .707Z M10 14 a1 1 0 0 0 2 0 c0 -.5 -.555 -1.395 -1 -2 -.445 .605 -1 1.5 -1 2Z m-6 -4 a1 1 0 1 0 2 0 c0 -.5 -.555 -1.395 -1 -2 -.445 .605 -1 1.5 -1 2Z m.293 4.707 A1 1 0 0 1 4 14 c0 -.5 .555 -1.395 1 -2 .445 .605 1 1.5 1 2 a1 1 0 0 1 -1.707 .707Z M1 14 a1 1 0 1 0 2 0 c0 -.5 -.555 -1.395 -1 -2 -.445 .605 -1 1.5 -1 2Z
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 1.293 10.707
                moveTo(x = 1.293f, y = 10.707f)
                // A 1 1 0 0 1 1 10
                arcTo(
                ...
                close()
                // m -0.707 4.707
                moveToRelative(dx = -0.707f, dy = 4.707f)
                // A 1 1 0 0 1 13 14
                arcTo(
                    horizontalEllipseRadius = 1.0f,
                    verticalEllipseRadius = 1.0f,
        ...
        }.build().also { _ic316Fill = it }
    }

@Suppress("ObjectPropertyName")
private var _ic316Fill: ImageVector? = null
