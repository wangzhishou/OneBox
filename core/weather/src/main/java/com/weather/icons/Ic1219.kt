...
val QWeatherIcons.Ic1219: ImageVector
    get() {
        val current = _ic1219
        if (current != null) return current

        return ImageVector.Builder(
            name = "QWeather.Ic1219",
            defaultWidth = 16.0.dp,
            defaultHeight = 16.0.dp,
            viewportWidth = 16.0f,
            viewportHeight = 16.0f,
        ).apply {
            // M10.833 13 c1.809 -.038 2.828 .07 4.594 .485 a.47 .47 0 0 0 .562 -.377 .497 .497 0 0 0 -.357 -.593 c-1.84 -.432 -2.934 -.548 -4.818 -.508 -1.174 .025 -2.072 .274 -2.922 .51 l-.012 .003 c-.852 .236 -1.657 .458 -2.713 .48 -1.809 .038 -2.828 -.07 -4.594 -.485 a.47 .47 0 0 0 -.562 .377 .497 .497 0 0 0 .357 .593 c1.84 .432 2.934 .548 4.818 .508 1.174 -.025 2.072 -.274 2.922 -.51 l.012 -.003 c.852 -.236 1.657 -.458 2.713 -.48Z m0 2 c1.809 -.038 2.828 .07 4.594 .485 a.47 .47 0 0 0 .562 -.377 .497 .497 0 0 0 -.357 -.593 c-1.84 -.432 -2.934 -.548 -4.818 -.508 -1.174 .025 -2.072 .274 -2.922 .51 l-.012 .003 c-.852 .236 -1.657 .458 -2.713 .48 -1.809 .038 -2.828 -.07 -4.594 -.485 a.47 .47 0 0 0 -.562 .377 .497 .497 0 0 0 .357 .593 c1.84 .432 2.934 .547 4.818 .508 1.174 -.025 2.072 -.274 2.922 -.51 l.012 -.003 c.852 -.236 1.657 -.458 2.713 -.48Z M10 1 l1.01 6.211 2.245 -2.872 2.245 4.79 v2.102 c-1.76 -.407 -2.847 -.516 -4.686 -.477 -1.174 .024 -2.072 .273 -2.922 .509 l-.012 .003 c-.852 .236 -1.657 .458 -2.713 .48 -1.809 .039 -2.828 -.069 -4.594 -.484 A.465 .465 0 0 0 .5 11.25 v-1.17 l3.262 -4.64 2.295 2.938 L10 1Z m-7.89 .421 c-.02 -.176 .16 -.327 .39 -.327 s.41 .151 .39 .327 L2.712 2.97 h-.426 L2.11 1.42Z m.705 2.173 a.312 .312 0 1 1 -.625 0 .312 .312 0 0 1 .625 0Z
            path(
                ...
                close()
                // M 10 1
                moveTo(x = 10.0f, y = 1.0f)
                // l 1.01 6.211
                lineToRelative(dx = 1.01f, dy = 6.211f)
                // l 2.245 -2.872
                lineToRelative(dx = 2.245f, dy = -2.872f)
                // l 2.245 4.79
                lineToRelative(dx = 2.245f, dy = 4.79f)
                // v 2.102
                verticalLineToRelative(dy = 2.102f)
                // c -1.76 -0.407 -2.847 -0.516 -4.686 -0.477
                curveToRelative(
                    dx1 = -1.76f,
                    dy1 = -0.407f,
                    dx2 = -2.847f,
                ...
                // c -1.174 0.024 -2.072 0.273 -2.922 0.509
                curveToRelative(
                    dx1 = -1.174f,
                    dy1 = 0.024f,
                    dx2 = -2.072f,
                ...
                // c -1.809 0.039 -2.828 -0.069 -4.594 -0.484
                curveToRelative(
                    dx1 = -1.809f,
                    dy1 = 0.039f,
                    dx2 = -2.828f,
                ...
                // l 3.262 -4.64
                lineToRelative(dx = 3.262f, dy = -4.64f)
                // l 2.295 2.938
                lineToRelative(dx = 2.295f, dy = 2.938f)
                // L 10 1z
                lineTo(x = 10.0f, y = 1.0f)
                close()
                // m -7.89 0.421
                moveToRelative(dx = -7.89f, dy = 0.421f)
            ...
            // M0 2.5 a2.5 2.5 0 1 0 5 0 2.5 2.5 0 0 0 -5 0Z m4.594 0 a2.094 2.094 0 1 1 -4.188 0 2.094 2.094 0 0 1 4.188 0Z
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 0 2.5
                moveTo(x = 0.0f, y = 2.5f)
                // a 2.5 2.5 0 1 0 5 0
                arcToRelative(
                    a = 2.5f,
                    b = 2.5f,
        ...
        }.build().also { _ic1219 = it }
    }

@Suppress("ObjectPropertyName")
private var _ic1219: ImageVector? = null
