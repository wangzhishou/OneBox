...
val QWeatherIcons.Ic305: ImageVector
    get() {
        val current = _ic305
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                close()
                // m -2.1 -4
                moveToRelative(dx = -2.1f, dy = -4.0f)
        ...
        }.build().also { _ic305 = it }
    }

@Suppress("ObjectPropertyName")
private var _ic305: ImageVector? = null
