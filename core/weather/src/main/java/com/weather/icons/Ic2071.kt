...
val QWeatherIcons.Ic2071: ImageVector
    get() {
        val current = _ic2071
        if (current != null) return current

        return ImageVector.Builder(
            name = "QWeather.Ic2071",
            defaultWidth = 16.0.dp,
            defaultHeight = 16.0.dp,
            viewportWidth = 16.0f,
            viewportHeight = 16.0f,
        ).apply {
            // M2.5 1.866 a1 1 0 1 0 -1 0 V15 H0 v1 h16 v-1 H2.5 V4.292 l2.13 1.277 c.046 -.129 .105 -.298 .161 -.486 L2.986 4 4.79 2.917 a9.43 9.43 0 0 0 -.162 -.486 L2.5 3.708 V1.866Z
            path(
            ...
            // M5.698 2.464 c.346 -.015 .8 -.032 1.302 -.042 V5.01 c-.46 .1 -.882 .198 -1.227 .281 l.048 -.171 C5.914 4.775 6 4.364 6 4 c0 -.383 -.096 -.82 -.195 -1.18 a9.243 9.243 0 0 0 -.107 -.356Z M8 2.414 c.509 .002 1.026 .015 1.5 .047 v2.094 c-.477 .063 -.992 .151 -1.5 .25 V2.413Z m2.5 .15 c.478 .067 .995 .159 1.5 .26 v1.59 a26.44 26.44 0 0 0 -1.5 .045 V2.564Z m2.5 .47 c.62 .137 1.16 .27 1.5 .354 v1.084 c-.368 -.017 -.9 -.039 -1.5 -.05 V3.034Z M5.11 1.493 a.601 .601 0 0 0 -.527 .814 c.06 .159 .167 .454 .258 .781 .093 .337 .159 .668 .159 .912 0 .23 -.058 .54 -.145 .86 a9.06 9.06 0 0 1 -.251 .778 c-.166 .444 .23 .92 .713 .796 .706 -.18 3.118 -.775 4.733 -.936 1.693 -.17 4.26 -.037 4.817 -.005 a.6 .6 0 0 0 .633 -.6 V3.077 a.6 .6 0 0 0 -.449 -.58 c-.47 -.122 -3.184 -.813 -5.001 -.995 -1.75 -.175 -4.328 -.044 -4.94 -.01Z m6.656 7.028 -4.777 .91 c-.283 .054 -.267 .393 .024 .498 l1.107 .403 L6.42 15 h6.386 l.952 -2.616 1.107 .403 c.29 .106 .52 -.143 .338 -.366 L12.13 8.653 a.39 .39 0 0 0 -.363 -.132Z m-1.64 3.606 .94 .342 a.5 .5 0 0 1 .3 .64 l-.343 .94 a.5 .5 0 0 1 -.64 .3 l-.94 -.343 a.5 .5 0 0 1 -.299 -.64 l.342 -.94 a.5 .5 0 0 1 .64 -.3Z
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 5.698 2.464
                ...
                close()
                // m 6.656 7.028
                moveToRelative(dx = 6.656f, dy = 7.028f)
                // l -4.777 0.91
                lineToRelative(dx = -4.777f, dy = 0.91f)
                // c -0.283 0.054 -0.267 0.393 0.024 0.498
                curveToRelative(
                    dx1 = -0.283f,
                    dy1 = 0.054f,
                    dx2 = -0.267f,
                ...
                // L 6.42 15
                lineTo(x = 6.42f, y = 15.0f)
                // h 6.386
                horizontalLineToRelative(dx = 6.386f)
                // l 0.952 -2.616
                lineToRelative(dx = 0.952f, dy = -2.616f)
                // l 1.107 0.403
                lineToRelative(dx = 1.107f, dy = 0.403f)
                // c 0.29 0.106 0.52 -0.143 0.338 -0.366
                curveToRelative(
                    dx1 = 0.29f,
                    dy1 = 0.106f,
                    dx2 = 0.52f,
                ...
                // L 12.13 8.653
                lineTo(x = 12.13f, y = 8.653f)
                // a 0.39 0.39 0 0 0 -0.363 -0.132z
                arcToRelative(
                    a = 0.39f,
                    b = 0.39f,
                    theta = 0.0f,
                ...
                close()
                // m -1.64 3.606
                moveToRelative(dx = -1.64f, dy = 3.606f)
                // l 0.94 0.342
                lineToRelative(dx = 0.94f, dy = 0.342f)
                // a 0.5 0.5 0 0 1 0.3 0.64
                arcToRelative(
                    a = 0.5f,
                    b = 0.5f,
                    theta = 0.0f,
                ...
                // l -0.343 0.94
                lineToRelative(dx = -0.343f, dy = 0.94f)
                // a 0.5 0.5 0 0 1 -0.64 0.3
                arcToRelative(
                    a = 0.5f,
                    b = 0.5f,
                    theta = 0.0f,
                ...
                // l -0.94 -0.343
                lineToRelative(dx = -0.94f, dy = -0.343f)
                // a 0.5 0.5 0 0 1 -0.299 -0.64
                arcToRelative(
                    a = 0.5f,
                    b = 0.5f,
                    theta = 0.0f,
        ...
        }.build().also { _ic2071 = it }
    }

@Suppress("ObjectPropertyName")
private var _ic2071: ImageVector? = null
