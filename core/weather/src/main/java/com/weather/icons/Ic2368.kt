...
val QWeatherIcons.Ic2368: ImageVector
    get() {
        val current = _ic2368
        if (current != null) return current

        return ImageVector.Builder(
            name = "QWeather.Ic2368",
            defaultWidth = 16.0.dp,
            defaultHeight = 16.0.dp,
            viewportWidth = 16.0f,
            viewportHeight = 16.0f,
        ).apply {
            // M1 0 H0 v16 h1 v-2.936 c.6 .627 1.6 .851 3.762 .323 C6.782 12.894 9 14 9 14 V8.608 c-2.305 -.87 -3.427 -.607 -5.143 -.203 l-.243 .056 C1.756 8.895 1 8 1 8 V6.064 c.6 .627 1.6 .851 3.762 .323 C6.782 5.894 9 7 9 7 V1.608 c-2.305 -.87 -3.427 -.607 -5.143 -.203 l-.243 .056 C1.756 1.894 1 1 1 1 V0Z m5.6 2.125 v3 L3.4 5.5 v-3 l3.2 -.375Z m0 7 v3 l-3.2 .375 v-3 l3.2 -.375Z M13 6 a3 3 0 1 0 0 -6 3 3 0 0 0 0 6Z m-.467 -4.294 c-.024 -.212 .192 -.393 .467 -.393 s.491 .181 .467 .393 l-.211 1.857 h-.512 l-.21 -1.857Z m.845 2.607 a.375 .375 0 1 1 -.75 0 .375 .375 0 0 1 .75 0Z
            path(
        ...
        }.build().also { _ic2368 = it }
    }

@Suppress("ObjectPropertyName")
private var _ic2368: ImageVector? = null
