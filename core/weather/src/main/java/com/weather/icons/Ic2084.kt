...
val QWeatherIcons.Ic2084: ImageVector
    get() {
        val current = _ic2084
        if (current != null) return current

        return ImageVector.Builder(
            name = "QWeather.Ic2084",
            defaultWidth = 16.0.dp,
            defaultHeight = 16.0.dp,
            viewportWidth = 16.0f,
            viewportHeight = 16.0f,
        ).apply {
            // M5.034 11.673 a1 1 0 0 0 1.932 .518 c.13 -.483 -.176 -1.492 -.448 -2.191 -.586 .47 -1.355 1.19 -1.484 1.673Z m-4.129 .051 a1 1 0 0 0 1.932 .518 c.129 -.483 -.176 -1.491 -.449 -2.19 -.586 .468 -1.354 1.19 -1.483 1.672Z m8.229 .708 a1 1 0 0 1 -.1 -.759 c.13 -.483 .898 -1.204 1.484 -1.673 .272 .7 .577 1.708 .448 2.19 a1 1 0 0 1 -1.832 .242Z m3.9 -.759 a1 1 0 1 0 1.932 .518 c.13 -.483 -.175 -1.492 -.448 -2.191 -.586 .47 -1.354 1.19 -1.484 1.673Z m-1.9 3.759 a1 1 0 0 1 -.1 -.759 c.13 -.483 .898 -1.204 1.484 -1.673 .272 .7 .577 1.708 .448 2.19 a1 1 0 0 1 -1.832 .242Z m-8.1 -.759 a1 1 0 0 0 1.932 .518 c.13 -.483 -.176 -1.492 -.448 -2.191 -.586 .47 -1.355 1.19 -1.484 1.673Z M7.9 10 a4.99 4.99 0 0 0 3.827 -1.783 3 3 0 1 0 .553 -5.63 A4.999 4.999 0 0 0 7.9 0 a4.998 4.998 0 0 0 -4.359 2.549 3 3 0 1 0 .586 5.732 A4.988 4.988 0 0 0 7.9 10Z m-.791 -6.398 c-.057 -.362 .17 -.8 .496 -.997 .256 -.153 .551 -.133 .806 .023 l.07 .042 a.846 .846 0 0 1 .409 .853 L8.532 5.8 H7.454 L7.11 3.602Z M8.599 6.9 a.6 .6 0 1 1 -1.2 0 .6 .6 0 0 1 1.2 0Z
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 5.034 11.673
                moveTo(x = 5.034f, y = 11.673f)
                ...
                // c 0.13 -0.483 -0.176 -1.492 -0.448 -2.191
                curveToRelative(
                    dx1 = 0.13f,
                    dy1 = -0.483f,
                    dx2 = -0.176f,
                ...
                // c -0.586 0.47 -1.355 1.19 -1.484 1.673z
                curveToRelative(
                    dx1 = -0.586f,
                    dy1 = 0.47f,
                    dx2 = -1.355f,
                ...
                close()
                // m -4.129 0.051
                moveToRelative(dx = -4.129f, dy = 0.051f)
                // a 1 1 0 0 0 1.932 0.518
                arcToRelative(
                    a = 1.0f,
                    b = 1.0f,
                ...
                close()
                // m 8.229 0.708
                moveToRelative(dx = 8.229f, dy = 0.708f)
                ...
                close()
                // m 3.9 -0.759
                moveToRelative(dx = 3.9f, dy = -0.759f)
                ...
                close()
                // m -1.9 3.759
                moveToRelative(dx = -1.9f, dy = 3.759f)
                // a 1 1 0 0 1 -0.1 -0.759
                arcToRelative(
                    a = 1.0f,
                    b = 1.0f,
                ...
                close()
                // m -8.1 -0.759
                moveToRelative(dx = -8.1f, dy = -0.759f)
                // a 1 1 0 0 0 1.932 0.518
                arcToRelative(
                    a = 1.0f,
                    b = 1.0f,
        ...
        }.build().also { _ic2084 = it }
    }

@Suppress("ObjectPropertyName")
private var _ic2084: ImageVector? = null
