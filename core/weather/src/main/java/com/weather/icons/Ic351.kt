...
val QWeatherIcons.Ic351: ImageVector
    get() {
        val current = _ic351
        ...
        }.build().also { _ic351 = it }
    }

@Suppress("ObjectPropertyName")
private var _ic351: ImageVector? = null
