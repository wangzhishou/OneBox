...
val QWeatherIcons.Ic304: ImageVector
    get() {
        val current = _ic304
        ...
        }.build().also { _ic304 = it }
    }

@Suppress("ObjectPropertyName")
private var _ic304: ImageVector? = null
