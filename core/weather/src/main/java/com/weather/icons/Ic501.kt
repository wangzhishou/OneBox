...
val QWeatherIcons.Ic501: ImageVector
    get() {
        val current = _ic501
        ...
        }.build().also { _ic501 = it }
    }

@Suppress("ObjectPropertyName")
private var _ic501: ImageVector? = null
