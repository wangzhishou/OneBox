...
import com.t8rin.imagetoolbox.core.resources.icons.line.LineEmojiNature
import com.t8rin.imagetoolbox.core.resources.icons.line.LineEmojiObjects
import com.t8rin.imagetoolbox.core.resources.icons.line.LineEmojiSymbols
import com.t8rin.imagetoolbox.core.resources.icons.line.LineEmojiFood
import com.t8rin.imagetoolbox.core.resources.icons.line.LineEmojiTransportation
        ...
        derivedStateOf {
            ...
            persistentListOf(
                ...
                EmojiData(
                    ...
                    icon = com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineEmojiNature,
                    emojis = Nature!!
                ),
                EmojiData(
                ...
                EmojiData(
                    ...
                    icon = com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineEmojiEvents,
                    emojis = Events!!
                ),
                EmojiData(
                    context.getString(R.string.travels_and_places),
                    com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineEmojiTransportation,
                    Transportation!!
                ),
                EmojiData(
                    title = context.getString(R.string.symbols),
                    icon = com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineEmojiSymbols,
                    emojis = Symbols!!
                )
            )
        }.value
