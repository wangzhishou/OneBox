...
val com.t8rin.imagetoolbox.core.resources.Icons.Rounded.Star: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Rounded.Star",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
...
val com.t8rin.imagetoolbox.core.resources.Icons.Outlined.Star: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Outlined.Star",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
