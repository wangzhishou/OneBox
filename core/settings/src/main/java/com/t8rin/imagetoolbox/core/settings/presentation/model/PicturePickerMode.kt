...
import com.t8rin.imagetoolbox.core.resources.icons.line.LinePhotoCameraBack
...
sealed class PicturePickerMode(
    ...
    data object CameraCapture : PicturePickerMode(
        ordinal = 4,
        icon = com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LinePhotoCameraBack,
