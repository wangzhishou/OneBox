...
interface SettingsInteractor : SimpleSettingsInteractor {
    ...
    suspend fun toggleGlassmorphismEnabled()

    suspend fun toggleLiquidGlassEnabled()

    suspend fun toggleMeshGradientBackgroundEnabled()

    suspend fun setCustomBackgroundImageUri(uri: String?)

    suspend fun setGradientBackgroundStyle(style: GradientBackgroundStyle)

    suspend fun setCustomBackgroundOverlayAlpha(alpha: Float)
