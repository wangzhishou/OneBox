...
val LocalSettingsManager =
    staticCompositionLocalOf<SettingsManager> { error("SettingsManager not present") }

val LocalThemeRepository =
    staticCompositionLocalOf<ThemeRepository> { error("ThemeRepository not present") }
