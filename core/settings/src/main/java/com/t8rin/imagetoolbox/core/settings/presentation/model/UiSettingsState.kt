    ...
    return remember(this, selectedEmoji) {
        derivedStateOf {
            UiSettingsState(
                ...
                customBackgroundImageUri = customBackgroundImageUri?.toUri()
                    ?.takeIf { it != Uri.EMPTY },
                gradientBackgroundStyle = gradientBackgroundStyle,
                customBackgroundOverlayAlpha = customBackgroundOverlayAlpha,
...
val defaultColorTuple = ColorTuple(
    primary = Color(0xFF9592EA),
    secondary = Color(0xFF73CDEC),
    tertiary = Color(0xFFD2B9EA),
