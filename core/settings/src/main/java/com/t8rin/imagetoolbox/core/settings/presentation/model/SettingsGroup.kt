...
sealed class SettingsGroup(
    ...
    data object PrimaryCustomization : SettingsGroup(
        id = 1,
        icon = com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineDesignServices,
    ...
    data object Layout : SettingsGroup(
        id = 3,
        icon = androidx.compose.material.icons.Icons.Rounded.ViewCarousel,
    ...
    data object NightMode : SettingsGroup(
        id = 4,
        icon = androidx.compose.material.icons.Icons.Rounded.ShieldMoon,
    ...
    data object Shadows : SettingsGroup(
        id = 5,
        icon = Icons.Filled.SquareHarmony,
    ...
    data object DefaultValues : SettingsGroup(
        id = 9,
        icon = androidx.compose.material.icons.Icons.Outlined.Architecture,
    ...
    data object Confetti : SettingsGroup(
        id = 24,
        icon = androidx.compose.material.icons.Icons.Rounded.Celebration,
