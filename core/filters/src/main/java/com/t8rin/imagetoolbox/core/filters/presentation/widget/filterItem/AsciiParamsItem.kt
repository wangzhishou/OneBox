            ...
            when (index) {
                0 -> {
                    Column(
                        ...
                        val customEntries = settings.customAsciiGradients - defaultItems.toSet()
                                ...
                                AnimatedContent(
                                    ...
                                    if (gradient.length > 1 && gradient !in default) {
                                        ...
                                        EnhancedIconButton(
                                            ...
                                            Icon(
                                                imageVector = if (saved) com.t8rin.imagetoolbox.core.resources.Icons.Rounded.Delete else com.t8rin.imagetoolbox.core.resources.Icons.Rounded.Save,
