...
import com.t8rin.imagetoolbox.core.resources.icons.line.LineExtensionOff
    ...
    AnimatedContent(
        ...
        if (noTemplates) {
            Column(
                ...
                Icon(
                    imageVector = com.t8rin.imagetoolbox.core.resources.Icons.Outlined.LineExtensionOff,
